function [sig, sig_bar, max_psf, l21_norm, nuclear_norm, l21_norm_x0, nuclear_norm_x0, dirty_image, B, s] = ...
...
B = B/Anorm; %! normalize noise by the operator norm
% B = B./reshape(Anorm, [1, nChannels]);
E = N*sum(var(B,0,1));
