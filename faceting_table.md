...
| [x]             | FHS (4x4, 0, 1/3xsig, 1xsig)      | 23.95 | 35.83 | 39.26 | 39.82 | 39.91 | 39.87 | 4.7590e-04               | 3.7047e-02               | 4.5194e-04, 7.1892e-05 | 1585033           | issue with the 1/3 here (change needed for 2d) |
| [x]             | FHS (4x4, 0.1, 1/3xsig, 1xsig)    | 23.81 | 35.92 | 39.36 | 39.89 | 39.96 | 39.92 | 4.7590e-04               |                          |                        | 1585034           |
| [x]             | FHS (4x4, 0.25, 1/3xsig, 1xsig)   | 23.61 | 35.73 |       |       |       |       |                          |                          |                        | 1585035           |
| [x]             | FHS (4x4, 0.4, 1/3xsig, 1xsig)    | 23.55 | 36.12 |       |       |       |       |                          |                          |                        | 1585036           |
| [x]             | FHS (4x4, 0.5, 1/3xsig, 1xsig)    | 24.19 | 36.21 |       |       |       |       |                          |                          |                        | 1585037           |
| [x]             | FHS (2x2, 0.1, 1/3xsig, 1xsig)    | 25.20 |       |       |       |       |       |                          |                          |                        | 1585038           |
| [x]             | FHS (3x3, 0.1, 1/3xsig, 1xsig)    | 24.07 | 35.47 |       |       |       |       |                          |                          |                        | 1585039           |
| --------------- | --------------------------------- | ----- | ----- | ----- | ----- | ----- | ----- | ------------------------ | ------------------------ | ---------------------- | ----------------- |
| [R]             | HS (1xsigma, 1/5xsigma)           |       |       |       |       |       |       |                          |                          |                        |                   |
| [R]             | FHS (4x4, 0, 1/3xsig, 1xsig)      |       |       |       |       |       |       |                          |                          |                        |                   |
| [R]             | FHS (4x4, 0.1, 1/3xsig, 1xsig)    |       |       |       |       |       |       |                          |                          |                        |                   |
| [R]             | FHS (4x4, 0.2, 1/3xsig, 1xsig)    |       |       |       |       |       |       |                          |                          |                        |                   |
| [R]             | FHS (4x4, 0.25, 1/3xsig, 1xsig)   |       |       |       |       |       |       |                          |                          |                        |                   |
| [R]             | FHS (4x4, 0.4, 1/3xsig, 1xsig)    |       |       |       |       |       |       |                          |                          |                        |                   |
| [R]             | FHS (4x4, 0.5, 1/3xsig, 1xsig)    |       |       |       |       |       |       |                          |                          |                        |                   |
| [R]             | FHS (2x2, 0.1, 1/3xsig, 1xsig)    |       |       |       |       |       |       |                          |                          |                        |                   |
| [R]             | FHS (3x3, 0.1, 1/3xsig, 1xsig)    |       |       |       |       |       |       |                          |                          |                        |                   |
| --------------- | --------------------------------- | ----- | ----- | ----- | ----- | ----- | ----- | ------------------------ | ------------------------ | ---------------------- | ----------------- |
...
| Run | Algo                  | rw 3 | rw 5  | asnr_log (x10, /10) | arun | acpu | total run (rw3, rw5) | total_cpu (rw3, rw5) | id                                |
| --- | --------------------- | ---- | ----- | ------------------- | ---- | ---- | -------------------- | -------------------- | --------------------------------- |
| [R] | SARA (1xsigma)        |      | 19.87 |                     |      |      |                      |                      | 1377423-1377522, 1386470, 1387816 |
| [R] | HS (Qc=1, 1sig, 1sig) |      |       |                     |      |      |                      |                      | 1585111                           |
| [R] | HS (Qc=2 1sig, 1sig)  |      | 22.08 |                     |      |      |                      |                      | 1585112-1585113                   |
| [R] | HS (Qc=5 1sig, 1sig)  |      | 22.21 |                     |      |      |                      |                      | 1585114-1585118                   |
| [R] | HS (Qc=10 1sig, 1sig) |      | 22.38 |                     |      |      |                      |                      | 1585119-1585128                   |

-> keep earlier results (corresponding to heuristic2d with 1/3xsig, 1xsig)!
