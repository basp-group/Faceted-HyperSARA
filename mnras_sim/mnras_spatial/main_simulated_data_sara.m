function main_simulated_data_sara(image_name, nChannels, Qx, Qy, Qc, ...
    ...
    coverage_path, gam, rw, ch, warm_start)
...
if strcmp(algo_version, 'sara')
    ...
    if flag_computeOperatorNorm
        ...
        save(fullfile(results_path,strcat('Anorm_sara_N=',num2str(Nx), ...
            '_L=',num2str(nChannels),'_Qc=',num2str(Qc),'_ind=',num2str(ind), 'ch=', num2str(ch), '.mat')),'-v7.3', 'Anorm');
        ...
        '_L=',num2str(nChannels),'_Qc=',num2str(Qc),'_ind=',num2str(ind), 'ch=', num2str(ch), '.mat')));
    end
else
    if flag_computeOperatorNorm
