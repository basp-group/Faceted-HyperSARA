...
with open(parameter_file_full_path, "r") as csvfile:
    ...
    for job in reader:
        ...
        slurm_command = """sbatch --job-name={0} --ntasks-per-node={1} \
            -e /lustre/home/sc004/pthouven/hyper-sara/logs/{0}_Qx={2}_Qy={3}_Qc={4}_L={5}_p={6}_snr={7}.err \
            -o /lustre/home/sc004/pthouven/hyper-sara/logs/{0}_Qx={2}_Qy={3}_Qc={4}_L={5}_p={6}_snr={7}.out \
