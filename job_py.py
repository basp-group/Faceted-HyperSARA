...
with open(parameter_file_full_path, "r") as csvfile:
    ...
    for job in reader:
        ...
        slurm_command = """sbatch --job-name={0} --ntasks-per-node={1} \
            ...
            -v --export=ALL,imgname={0},Qx={2},Qy={3},Qc={4},nchannels={5},p={6},snr={7},algoversion={8},wintype={9},ncdata={10},ind={11},overlapsize={12},gencube={13},gencov={14},genvis={15},genundersampledcube={16},computenorm={16},solve={17},cubepath={18},covpath={19} \
