function [v2, Ftx, proj, norm_res, norm_residual_check_c, norm_epsilon_check_c, norm_residual_check_a, norm_epsilon_check_a] = update_data_fidelity_dr_block_new(v2, y, xhat, proj, A, At, H, W, T, Wm, pU, epsilon, ...
