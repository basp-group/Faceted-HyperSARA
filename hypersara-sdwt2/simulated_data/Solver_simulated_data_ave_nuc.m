...
%% L21 + Nuclear
if solve_HS
    [xsol,v0,v1,v2,g,weights0,weights1,proj,t_block,reweight_alpha,epsilon,iterh,rel_fval,nuclear,l21,norm_res,res] = pdfb_LRJS_Adapt_blocks_rwNL21_par_precond_new_sim_nuc_ave(y_t{q}, epsilons_t{q}, A, At, aW, G, W, Av, Avt, Psi, Psit, param_HSI, X0);
    if save_data
...
%%
save('result_66ch_ave3_nuc_noHI.mat','-v7.3','xsol', 'sol', 'X0', 'SNR', 'SNR_average', 'res');

fitswrite(xsol,'xsol_ave3_nuc_noHI.fits')
