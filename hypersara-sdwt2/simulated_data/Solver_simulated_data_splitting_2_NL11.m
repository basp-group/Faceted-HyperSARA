...
Spt2 = @(x) Split_adjoint_operator2(x,chunks,Ny,Nx,length(ch));
...
Spt_psi = @(x) Split_sparsity_adjoint_operator(x,Spt2,Psi_full);
...
%% L21 + Nuclear
if solve_HS
    [xsol,v0,v1,v2,g,weights0,weights1,proj,t_block,reweight_alpha,epsilon,iterh,rel_fval,nuclear,l21,norm_res,res] = pdfb_LRJS_Adapt_blocks_rwNL11_par_precond_new_sim_NL11_split(y_t{q}, epsilons_t{q}, A, At, aW, G, W, Sp, Spt, Spt2, Psi, Psit, param_HSI, X0);
    if save_data
...
fitswrite(xsol,'./xsol_NL21_10000.fits')
