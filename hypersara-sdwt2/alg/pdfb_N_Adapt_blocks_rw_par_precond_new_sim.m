function [xsol,v0,v2,g,weights0,proj,t_block,reweight_alpha,epsilon,t,rel_fval,nuclear,norm_res,res] = pdfb_N_Adapt_blocks_rw_par_precond_new_sim(y, epsilon, A, At, pU, G, W, Psi, Psit, param,X0)
