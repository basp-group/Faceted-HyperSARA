function [xsol,v1,v2,g,weights1,proj,t_block,reweight_alpha,epsilon,t,rel_fval,l21,norm_res,res] = pdfb_L21_Adapt_blocks_rw_par_precond_new_sim_split(y, epsilon, A, At, pU, G, W, Sp, Spt, Psi, Psit, param, X0)
