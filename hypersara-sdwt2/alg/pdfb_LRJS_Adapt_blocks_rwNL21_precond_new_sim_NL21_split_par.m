function [xsol,v0,v1,v2,g,weights0,weights1,proj,t_block,reweight_alpha,epsilon,t,rel_fval,nuclear,l21,norm_res,res,end_iter] = pdfb_LRJS_Adapt_blocks_rwNL21_precond_new_sim_NL21_split_par(y, epsilon, A, At, pU, G, W, Sp, Spt, Psi, Psit, param, X0)
...
for t = t_start : param.max_iter
    ...
    g = sigma00*Spt(g0) + sigma11*Spt(u1) + sigma22*Ftx;
    % Free memory
    %g0=[]; g1=[]; Ftx=[];
