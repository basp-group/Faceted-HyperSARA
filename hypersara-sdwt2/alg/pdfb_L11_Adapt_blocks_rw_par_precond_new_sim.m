function [xsol,v1,v2,g,weights1,proj,t_block,reweight_alpha,epsilon,t,rel_fval,l11,norm_res,res] = pdfb_L11_Adapt_blocks_rw_par_precond_new_sim(y, epsilon, A, At, pU, G, W, Psi, Psit, param, X0)
