function [xsol,v0,v1,v2,g,weights0,weights1,proj,t_block,reweight_alpha,epsilon,t,rel_fval,nuclear,l11,norm_res,res] = pdfb_LRJS_Adapt_blocks_rwNL11_par_precond_new_sim(y, epsilon, A, At, pU, G, W, Psi, Psit, param,X0)
