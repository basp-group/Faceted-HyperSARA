function main_simulated_data(num_workers, tot, chunk_width, step, Qx, Qy, flag_algo)
...
for  i = 1 :step: tot-chunk_width+1
    chunks = [chunks; i i+chunk_width-1]; % [P.-A.] not all the bands are considered with this procedure, e.g., with the above choice of parameters
end
