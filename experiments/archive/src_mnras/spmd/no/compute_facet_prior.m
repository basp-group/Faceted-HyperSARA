function [l21_norm, nuclear_norm] = compute_facet_prior(x_overlap, crop, Iq, ...
    offset, status_q, nlevel, wavelet, Ncoefs_q, dims_overlap_ref_q, ...
    offsetLq, offsetRq, size_v1)
%compute_facet_prior: compute the value of the faceted prior (l21 + nuclear 
