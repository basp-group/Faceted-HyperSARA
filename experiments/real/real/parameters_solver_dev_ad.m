...
param_solver.cube_id = subcube_ind;
...
% nReweights times)
param_solver.reweighting_max_iter = max(param_reg.nReweights, param_solver.reweighting_min_iter + 1);
...
param_solver.alph = param_reg.gam;
param_solver.alph_bar = param_reg.gam_bar;
