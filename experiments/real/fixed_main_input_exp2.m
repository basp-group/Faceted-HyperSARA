...
param_global.pixelSize =0.06; 0.0424;%asec
%faceting params
param_global.Qx =1;
param_global.Qy =1;
param_global.Qc =1;
...
param_global.main_dir =['/Users/ad33/CodesScience/Faceted-Hyper-SARA/'];
...
spwins2image = 1;%[1 2 3 4 5 6];% [1:17 19 21:32]; %ids of the channels to be imaged from spwin=spwin_ind;
