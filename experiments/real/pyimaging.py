...
def main():
   ...
   with open(parameter_file, "rt") as csvfile:
        ...
        for job in reader:
            ...
            # command to launch
            sbatch_command = """sbatch --job-name {jobname} --error {log}.err --output {log}.out  --export=LOG={log}.log,PDIR={projectpath},ALGO={3},IMAGENAME={0},GAM={4},GAMBAR={5},SUBCUBE={2},RUNID={1},RW={6},nRW={7},LOG={log}.log  {slurmFile}""".format(*job,jobname=job_name,slurmFile=slurm_file,log=log_file,projectpath=project_path_run) 
