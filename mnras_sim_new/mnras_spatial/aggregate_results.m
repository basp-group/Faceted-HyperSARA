...
fprintf("%s, asnr = %2.2f (\pm %1.2e), asnr_log = %2.2f (\pm %1.2e), cpu_cores = %i, iteration_number = %i \n", ...
    algo, asnr, ssnr, asnr_log, ssnr_log, ncpu, iteration_number)
fprintf(" arun (s) = %.2f (\pm %1.2e), total_runtime (h) = %2.2f \n", ...   
    arun, srun, total_runtime/3600);
fprintf("acpu (s) = %.2f (\pm %1.2e) , total_cpu_time (h) = %2.2f \n", ...
