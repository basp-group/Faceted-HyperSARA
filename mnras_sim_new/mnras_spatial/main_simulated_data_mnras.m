function main_simulated_data_mnras(image_name, nChannels, Qx, Qy, Qc, ...
    ...
    superresolution_factor, isnr, update_regularization, flag_cirrus, regtype)
...
if strcmp(algo_version, 'sara')
    ...
    if flag_computeLowerBounds
        ...
        save(fullfile(auxiliary_path, ...
            ...
            'sig', 'max_psf', 'l11_norm', 'l11_norm_x0', 'dirty_image_precond', 'mu');
    else
    ...
    if flag_computeLowerBounds
        ...
        [sig, sig_bar, mu0, mu, mu_bar, mu_bar_full, max_psf, l21_norm, nuclear_norm, l21_norm_x0, nuclear_norm_x0, dirty_image_precond] = ...
        ...
        '_ind=', num2str(ind), ...
        '_rwtype=', rwtype, '_regtype=', regtype, '_snr=', num2str(isnr), '.mat')), ...
            'sig', 'sig_bar', 'max_psf', 'l21_norm', 'nuclear_norm', 'dirty_image_precond', 'mu', 'l21_norm_x0', 'nuclear_norm_x0', 'mu_bar', 'mu_bar_full');            
        ...
        load(fullfile(auxiliary_path, ...
            ...
            '_ind=', num2str(ind), ...
            '_rwtype=', rwtype, '_regtype=', regtype,'_snr=', num2str(isnr), '.mat')), ...
            'sig', 'sig_bar', 'max_psf', 'l21_norm', 'nuclear_norm', 'mu', 'mu_bar', 'mu_bar_full');
    end
