...
if strcmp(algo_version, 'sara')
    ...
    if flag_computeLowerBounds
        ...
        %? temporary test to check with another noise transfer operator
        [sig, sig_bar, mu0, mu, mu_bar, ~, max_psf, l21_norm, nuclear_norm, l21_norm_x0, nuclear_norm_x0, dirty_image] = compute_reweighting_lower_bound_test(y, W, G, aW, A, At, Ny, Nx, oy, ox, ...
