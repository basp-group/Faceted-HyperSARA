...
if strcmp(algo_version, 'sara')
    ...
    if flag_computeLowerBounds
        ...
        switch regtype
            case "inv"
                [sig, sig_bar, mu0, mu, mu_bar, mu_bar_full, max_psf, l21_norm, nuclear_norm, l21_norm_x0, nuclear_norm_x0, dirty_image] = ...
        ...
        '_ind=', num2str(ind), ...
        '_rwtype=', rwtype, '_regtype=', regtype, '_snr=', num2str(isnr), '.mat')), ...
            'sig', 'sig_bar', 'max_psf', 'l21_norm', 'nuclear_norm', 'dirty_image', 'mu', 'l21_norm_x0', 'nuclear_norm_x0', 'mu_bar', 'mu_bar_full');            
