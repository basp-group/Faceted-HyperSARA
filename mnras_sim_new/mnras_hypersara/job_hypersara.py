...
with open(parameter_file_full_path, "r") as csvfile:
    ...
    for job in reader:
        ...
        slurm_command = """sbatch --job-name={5}_{1} --ntasks-per-node={19} \
            ...
            -v --export=ALL,imgname={0},nchannels={1},Qx={2},Qy={3},Qc={4},algoversion={5},wintype={6},ncdata={7},ind={8},overlapfractiony={9},overlapfractionx={10},nreweights={10},gencube={11},gencov={12},genvis={13},genundersampledcube={14},computenorm={15},solve={16},covpath={17},gam={18},ncpus={19},rw={20} \
