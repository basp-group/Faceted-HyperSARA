...
for q = 1 : length(input_snr) * num_tests %number of tests x number of InSNRs
    ...
    if solve_HS
        ...
        [xsol,v1,v2,g,weights1,proj,t_block,reweight_alpha,epsilon,iterh,rel_fval,l21,norm_res,res] = ...       
        pdfb_L21_Adapt_blocks_rw_par_precond_new_sim(y_t{q}, epsilons_t{q}, A, At, aW, G, W, Psi, Psit, param_HSI, X0);
        if save_data
