...
param_HSI.gamma0 = 1;
param_HSI.gamma = 5e-2;  %convergence parameter L1 (soft th parameter)
...
%% L21 + Nuclear
if solve_HS
    [xsol,v0,v1,v2,g,weights0,weights1,proj,t_block,reweight_alpha,epsilon,iterh,rel_fval,nuclear,l21,norm_res,res] = pdfb_LRJS_Adapt_blocks_rwNL21_par_precond_new_sim_l21_split(y_t{q}, epsilons_t{q}, A, At, aW, G, W, Sp, Spt, Psi, Psit, param_HSI, X0);
    if save_data
...
fitswrite(xsol,'./xsol_l21_10000.fits')
