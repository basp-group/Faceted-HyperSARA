function [xsol,v0,v1,v2,g,weights0,weights1,proj,t_block,reweight_alpha,epsilon,t,rel_fval,nuclear,l21,norm_res,res] = pdfb_LRJS_Adapt_blocks_rwNL21_par_precond_new_sim_l21_ave(y, epsilon, A, At, pU, G, W, Av, Avt, Psi, Psit, param,X0)
...
for t = t_start : param.max_iter
    ...
    g = sigma00*g0 + sigma11*Avt(g1) + sigma22*Ftx;
    % Free memory
    g0=[]; g1=[]; Ftx=[];
