function [xsol,v0,v1,v2,g,weights0,weights1,proj,t_block,reweight_alpha,epsilon,t,rel_fval,nuclear,l21,norm_res,res] = pdfb_LRJS_Adapt_blocks_rwNL21_precond_sim_NL21_split_sdwt2(y, epsilon, A, At, pU, G, W, Sp, Spt, param, X0, wavelet, L, Qx, Qy)
...
c = size(y,2);
P = numel(wavelet); % number of wavelet dictionaries
...
% initial dual variables (sdwt2), define constants
