...
for band = 1:size(xhs,3)
    ...
    'Color',[1 1 1],...
    'LineWidth',4);
    export_fig(['figs/xhs_z11_ch', num2str(band),'.png'],'-transparent')
    ...
    'Color',[1 1 1],...
    'LineWidth',4);
    export_fig(['figs/xl1_z11_ch', num2str(band),'.png'], '-transparent')
...
for band = 1:size(xhs,3)
    ...
    'Color',[1 1 1],...
    'LineWidth',4);
    export_fig(['figs/xhs_z31_ch', num2str(band),'.png'],'-transparent')
    ...
    'Color',[1 1 1],...
    'LineWidth',4);
    export_fig(['figs/xl1_z31_ch', num2str(band),'.png'], '-transparent')
...
%     'Color',[1 1 1],...
%     'LineWidth',4);
%     export_fig(['figs/xclean_z3_ch', num2str(band),'.png'], '-transparent')
...
%     % Create rectangle
    ...
    'Color',[1 1 1],...
    'LineWidth',4);
      export_fig(['figs/xhs_z21_ch', num2str(band),'.png'], '-transparent')
...
%     % Create rectangle
    ...
    'Color',[1 1 1],...
    'LineWidth',4);
    export_fig(['figs/xl1_z21_ch', num2str(band),'.png'], '-transparent')
