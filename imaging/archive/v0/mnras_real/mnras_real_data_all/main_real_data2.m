...
temp_results_name = @(nchannels) strcat('fhs_', algo_version,'_',window_type,'_Nx=',num2str(Nx), '_Ny=',num2str(Ny), ...
    ...
    '_primal=', num2str(flag_primal), '_homotopy=', num2str(flag_homotopy));
...
if flag_solveMinimization
    ...
    fullfile(results_path,warm_start(nChannels)), fullfile(results_path,temp_results_name(nChannels)), flag_primal, flag_homotopy);
