function get_sara_cube(pathname, Ny, Nx, nChannels, gam, homotopy, rwtype, ...
    ...
    cubename = @(channel) strcat("x_cygASband_Cube_512_1024_20_sara_srf=2_none_Qy=1_Qx=1_Qc=20_gam=", num2str(gam), "_homotopy=", num2str(homotopy), "_rwtype=", rwtype,"_snr=40.fits");
