...
if flag_metric
    ...
    for l = 1:L
        ...
        total_cpu_time = total_cpu_time + ncores_l11*sum(t_l11(t_l11 > 0)) + ...
            ...
            + sum(t_data(t_data > 0));
        sum_cpu_sqr = sum_cpu_sqr + sum((ncores_l11*t_l11(t_l11 > 0) + t_master(t_master > 0) ...
            + t_data(t_data > 0)).^2);
    end
    ...
    iteration_number = round(iteration_number/L); % average number of iterations for each SARA problem
