...
# new option
qsub_command = "sbatch -J solver_facet_hyper_dr_mnras_gamma0{5}_gamma{6} --export datadir='{0}',name='{1}',Qx={2},Qy={3},Qc={4},gamma0={5},gamma={6},subInd={7},fouRed_gamma={8},adpteps={9},primal={10},homotopy={11},computelowerbounds={12} solver_facet_hyper_dr_composite_mnras.slurm".format(
    datadir,
    name,
    Qx,
    Qy,
