...
addpath ../../mnras_faceted_corrected/final_dr/gamma5e-6/7000
...
%%
res = fitsread('facethyperSARA_res_it7000_gamma5e-06_gamma0_0.001_2b_fouRed2_perc15_adpteps0.fits');
res = res./reshape(scale_factors, [1, 1, 30]);
fitswrite(res, 'res_hs_1e-3.fits');
