...
%     xhs = cat(3,flipud(xhs(:,:,[1,end])), flipud(mean(xhs, 3)));
%     xl1 = cat(3,flipud(xl1(:,:,[1,end])), flipud(mean(xl1, 3)));
%     xclean = cat(3,flipud(xclean(:,:,[1,end])), flipud(mean(xclean, 3)));
end
[N1, N2, c] = size(xhs);
...
%     rhs = cat(3,flipud(rhs(:,:,[1,end])), flipud(mean(rhs, 3)));
%     rl1 = cat(3,flipud(rl1(:,:,[1,end])), flipud(mean(rl1, 3)));
%     rclean = cat(3,flipud(rclean(:,:,[1,end])), flipud(mean(rclean, 3)));
end
...
for band = 1:size(xhs,3)
    ...
    set(h,'Position',[0.13    0.293   0.7750    0.0164]);% To change size
%     % Create rectangle
...
%         'LineWidth',1);
    export_fig(['figs/xhs_ch', num2str(band),ext], '-transparent', '-q101')
%     exportgraphics(f,['figs/xhs_ch', num2str(band),ext],'BackgroundColor','none','ContentType','vector')
    close
    ...
    set(h,'Position',[0.13    0.293   0.7750    0.0164]);
%         % Create rectangle
%     annotation(f,'rectangle',...
%         [0.181 0.34 0.035 0.0426555252756772],'Color',[1 1 1],...
%         'LineWidth',1);
...
%         [0.494 0.5 0.013 0.0169286577992742],'Color',[1 1 1],...
%         'LineWidth',1);
    export_fig(strcat('figs/xl1_ch', num2str(band),ext), '-transparent', '-q101')
%     exportgraphics(f,strcat('figs/xl1_ch', num2str(band),ext),'BackgroundColor','none','ContentType','vector')
    close
    %waitforbuttonpress;
end
...
for band = 1:size(xhs,3)
    ...
    a=get(h);
    a = a.Position; %gets the position and size of the color bar
    set(h,'Position',[0.13    0.293   0.7750    0.0164]);
%     % Create rectangle
%     annotation(f,'rectangle',...
%         [0.181 0.34 0.035 0.0426555252756772],'Color',[1 1 1],...
...
%         [0.494 0.5 0.013 0.0169286577992742],'Color',[1 1 1],...
%         'LineWidth',1);
    export_fig(strcat('figs/xclean_ch', num2str(band), ext), '-transparent', '-q101')
    close
    %waitforbuttonpress;
end
...
for band = 1:size(xhs,3)
    ...
    export_fig(strcat('figs/rhs_ch', num2str(band), ext),'-transparent', '-q101')
    close
    ...
    export_fig(strcat('figs/rl1_ch', num2str(band), ext), '-transparent', '-q101')
    close
    ...
    export_fig(strcat('figs/rclean_ch', num2str(band), ext), '-transparent', '-q101')
    close
    %waitforbuttonpress
end
...
for band = 1:size(xhs,3)
    ...
    'Color',[1 1 1],...
    'LineWidth',4);
    export_fig(strcat('figs/xhs_z1_ch', num2str(band),'.png'),'-transparent')
    close
    ...
    'Color',[1 1 1],...
    'LineWidth',4);
    export_fig(strcat('figs/xl1_z1_ch', num2str(band),'.png'), '-transparent')
    close
    ...
    'Color',[1 1 1],...
    'LineWidth',4);
    export_fig(strcat('figs/xclean_z1_ch', num2str(band),'.png'), '-transparent')
    close
    %waitforbuttonpress
end
...
for band = 1 : size(xhs,3)
    ...
    'Color',[1 1 1],...
    'LineWidth',4);
    export_fig(strcat('figs/xhs_z2_ch', num2str(band),'.png'), '-transparent')
    close
    ...
    'Color',[1 1 1],...
    'LineWidth',4);
    export_fig(strcat('figs/xl1_z2_ch', num2str(band),'.png'), '-transparent')
    close
    ...
    'Color',[1 1 1],...
    'LineWidth',4);
    export_fig(strcat('figs/xclean_z2_ch', num2str(band),'.png'), '-transparent')
    close
    %waitforbuttonpress
end