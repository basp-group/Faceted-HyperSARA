function cirrus_nnls_dr_reduced_data(chInd, reduction_version, fouRed_gamma)
% chInd = 1;
% reduction_version = 2;
fprintf('Channel number %d\n', chInd);
fprintf('Reduction level: remove singular values outside the interval of "%d-sigma"\n', fouRed_gamma);
...
param_fouRed.enable_klargestpercent = 0;
...
% save(['./CYG_DR_th', num2str(fouRed_gamma),'=', num2str(chInd), '.mat'],'-v7.3', 'yT', 'T', 'aW', 'Wm', 'epsilon');
...
save(['/lustre/home/shared/sc004/dr_2b_result_real_data/CYG_H=', num2str(chInd), '.mat'],'-v7.3', 'H');
save(['/lustre/home/shared/sc004/dr_2b_result_real_data/CYG_DR_th', num2str(fouRed_gamma),'=', num2str(chInd), '.mat'],'-v7.3', 'yT', 'T', 'aW', 'Wm', 'epsilon');
