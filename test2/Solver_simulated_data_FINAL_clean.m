...
if flag_algo == 1
    ...
    mkdir('results')
    save(['results/result_HyperSARA_serial_' num2str(tot) '_' num2str(T) '_' num2str(hrs) '.mat'],'-v7.3','xsol', 'sol', 'X0', 'SNR', 'SNR_average', 'res','end_iter');
    fitswrite(xsol,'results/xsol_HyperSARA_serial.fits')
...
if flag_algo == 11
    ...
    mkdir('results')
    save(['results/result_HyperSARA_parfeval_' num2str(tot) '_' num2str(T) '_' num2str(hrs) '.mat'],'-v7.3','xsol', 'sol', 'X0', 'SNR', 'SNR_average', 'res','end_iter');
    fitswrite(xsol,'results/xsol_HyperSARA_parfeval.fits')
    fitswrite(x0,'results/x0.fits')
end
...
if flag_algo == 111
    ...
    mkdir('results')
    save(['results/result_HyperSARA_spmd_' num2str(tot) '_' num2str(T) '_' num2str(hrs) '.mat'],'-v7.3','xsol', 'sol', 'X0', 'SNR', 'SNR_average', 'res','end_iter');
    fitswrite(xsol,'results/xsol_HyperSARA_spmd.fits')
    fitswrite(x0,'results/x0.fits')
end
