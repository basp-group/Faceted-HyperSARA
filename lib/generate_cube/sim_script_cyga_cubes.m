...
fitswrite(spectralIds2k,['SpectralIdxMap' num2str(size(cube2k,1)) '_' num2str(size(cube2k,2)) '_' num2str(size(cube2k,3))     '.fits']);
fitswrite(spectralIds512,['SpectralIdxMap' num2str(size(cube512,1)) '_' num2str(size(cube512,2)) '_' num2str(size(cube512,3))     '.fits']);

fitswrite(Curv2k,['CurvMap' num2str(size(cube2k,1)) '_' num2str(size(cube2k,2))  '_' num2str(size(cube2k,3))    '.fits']);
