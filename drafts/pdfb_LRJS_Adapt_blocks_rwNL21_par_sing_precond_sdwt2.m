function [xsol,v0,v1,v2,g,weights0,weights1,t_block,reweight_alpha,epsilon,t,rel_fval,nuclear,l21,norm_res,res] = pdfb_LRJS_Adapt_blocks_rwNL21_par_sing_precond_sdwt2(y, imsize, epsilon, A, At, pU, T, W, Psi, Psit, param,X0)
