...
%     'Color',[1 1 1],...
%     'LineWidth',4);
%     export_fig(['figs/xhs_z1_ch', num2str(band),extension],'-transparent', '-q101')
%     
%     %
%     xl1_z = xl1(:,:,band);
...
%     'Color',[1 1 1],...
%     'LineWidth',4);
%     export_fig(['figs/xl1_z1_ch', num2str(band),extension], '-transparent', '-q101')
%     
%     %
...
%     'Color',[1 1 1],...
%     'LineWidth',4);
%     export_fig(['figs/xhs_z2_ch', num2str(band),extension], '-transparent', '-q101')
%     
%     %
%     xl1_z = xl1(:,:,band);
%     xl1_z1 = xl1_z(cen(1)-len/2:cen(1)+len/2,cen(2)-len/2:cen(2)+len/2);
...
%     'Color',[1 1 1],...
%     'LineWidth',4);
%     export_fig(['figs/xl1_z2_ch', num2str(band),extension], '-transparent', '-q101')
%     
%     %
%     xclean_z = xclean(:,:,band);
%     xclean_z(xclean_z < 0) = 0;
