...
with open(parameter_file_full_path, "r") as csvfile:
    ...
    for job in reader:
        ...
        slurm_command = """sbatch --job-name={6} \
            ...
            -v --export=ALL,Qx={0},Qy={1},Qc={2},algoversion={3},wintype={4},ncdata={5},ind={6},overlapsize={7},nreweights={8},extractdata={9},computenorm={10},solve={11},gam0={12},gam={13},rw={14},alpha={15},ncpus={16},initoption={17} \
