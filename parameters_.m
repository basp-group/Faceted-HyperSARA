...
%% Blocking (user defined)
% density-based
% ! default: snapshot-based
...
%% NNLS (user defined)
% TODO: to be discussed (keep it or not?)
...
% real data
% TODO: whitening? (add natural weighting, default)
