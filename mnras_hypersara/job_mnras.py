...
with open(parameter_file_full_path, "r") as csvfile:
    ...
    for job in reader:
        ...
        slurm_command = """sbatch --job-name={5}_{1} --ntasks-per-node={19} \
            -e {5}_{0}_L={1}_Qx={2}_Qy={3}_Qc={4}_id={8}_overlap={9}_gamma={18}.err \
            -o {5}_{0}_L={1}_Qx={2}_Qy={3}_Qc={4}_id={8}_overlap={9}_gamma={18}.out \
            -v --export=ALL,imgname={0},nchannels={1},Qx={2},Qy={3},Qc={4},algoversion={5},wintype={6},ncdata={7},ind={8},overlapsize={9},nreweights={10},gencube={11},gencov={12},genvis={13},genundersampledcube={14},computenorm={15},solve={16},covpath={17},gam={18},ncpus={19} \
