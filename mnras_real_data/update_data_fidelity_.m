function [v2, Ftx, proj, norm_res, global_norm_res_c, norm_epsilon_c, global_norm_res_a, norm_epsilon_a] = update_data_fidelity(v2, y, xhat, proj, A, At, G, W, pU, epsilon, ...
...
for i = 1 : ci
    ...
    for j = 1 : length(G{i})
        ...
        v2{i}{j} = v2{i}{j} + r2 - proj_l2ball(v2{i}{j} + r2, epsilon{i}{j}, y{i}{j});
