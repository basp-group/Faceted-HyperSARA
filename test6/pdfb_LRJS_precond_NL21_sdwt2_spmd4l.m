...
%             tw = tic;
            ...
            g = sigma11.Value*g1;  %sigma00.Value*g0 + sigma11.Value*g1;
...
if (reweight_step_count == 0) || (reweight_step_count == 1) || (~mod(reweight_step_count,5))
   save(['./results/result_spmd4_l21_'  num2str(param.gamma) '_' num2str(reweight_step_count) '.mat'],'-v7.3','xsol','res','SNR','SNR_average');
end
