...
%         A, At, H_spmd, aW_spmd, T_spmd, W_spmd, param_HSI, X0, Qx, Qy, Qc2, ...
%         wlt_basis, L, nlevel, cell_c_chunks, ch(end), 'whatever.mat'); % [09/10/2019] ok basic debugging
...
%     wlt_basis, L, nlevel, cell_c_chunks, ch(end), d, window_type); % old
%     interface ()

    [xsol,param,epsilon,t,rel_fval,nuclear,l21,norm_res_out,end_iter] = ...
    facetHyperSARA_cst_overlap_weighted_dr(y_spmd, [Ny, Nx], ...
    epsilon_spmd, A, At, H_spmd, aW_spmd, T_spmd, W_spmd, param_HSI, X0, Qx, Qy, Qc2, ...
    wlt_basis, L, nlevel, cell_c_chunks, ch(end), d, window_type, 'results/facetHyperSARA_dr_co_w_0_0.01_0.mat'); 
...
%     wlt_basis, L, nlevel, cell_c_chunks, ch(end), d, window_type); % [09/10/2019] ok basic debugging

%     [xsol,param,epsilon,t,rel_fval,nuclear,l21,norm_res_out,end_iter] = ...
%     facetHyperSARA_cst_overlap_weighted_dr_real_data(y_spmd, [Ny, Nx], ...
%     epsilon_spmd, A, At, H_spmd, aW_spmd, T_spmd, W_spmd, param_HSI, Qx, Qy, Qc2, ...
%     wlt_basis, L, nlevel, cell_c_chunks, ch(end), d, window_type, 'whatever.mat'); % [09/10/2019] ok basic debugging
